    ...
    switch (document.documentElement.currentpage) {
        ...
        case 'download.html':
            if (lang === 'en') {
                ...
                document.getElementById('desc-download-zip').innerHTML = '1. Unzip the file<br/> 2. Open the browser extension manager by typing "chrome://extensions/" (without the double quotes) in the address bar.<br/> 3. In case it is disabled, check the "Developer mode" option.<br/> 4. Click on "Load unzipped" and select the AccesaWeb folder.<br/> 5. Done! You now have AccesaWeb in your browser. As a recommendation, you can pin it to the navigation bar and by clicking on the icon <br/> you will enter the AccesaWeb configuration menu.<br/>';
            } else {
